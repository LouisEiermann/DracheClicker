    ...
    render() {
        return (
            <div className="shop">
                ...
                <div className="items">
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'pfad', power: 1, price: 5000, haider: this.props.haider}))
                    }} ref={this.froschItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'herz', power: 1, price: 10000, haider: this.props.haider}))
                    }} ref={this.pizzaschieberItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'herz', power: 2, price: 20000, haider: this.props.haider}))
                    }} ref={this.pizzaItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'rewe', power: 1, price: 40000, haider: this.props.haider}))
                    }} ref={this.monsterItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'rewe', power: 2, price: 80000, haider: this.props.haider}))
                    }} ref={this.honigItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'rewe', power: 3, price: 160000, haider: this.props.haider}))
                    }} ref={this.ofenkaeseItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'rewe', power: 4, price: 320000, haider: this.props.haider}))
                    }} ref={this.loeschzwergItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({type: 'grab', power: 1, price: 640000, haider: this.props.haider}))
                    }} ref={this.lkwItem} className="item" hidden>
                    ...
                    <div onClick={() => {
                        this.props.dispatch(addItem({
                            ...
                            power: 2,
                            price: 1280000,
                            haider: this.props.haider
                        }))
                    }} ref={this.lugerItem} className="item" hidden>
